	...
	class SLP_GFL_Free_Admin extends SLP_BaseClass_Admin {
		...
		public function get_location_fields() {
			...
			$location_fields = array(
				...
				'sl_latitude'      => __('Latitude'       ,'slp-gravity-forms-locations-free'),
				'sl_longitude'      => __('Longitude'       ,'slp-gravity-forms-locations-free'),
				'sl_url'        => $this->slplus->WPML->get_text( 'label_website' ,
										$this->slplus->settings->get_item( 'label_website' , __('Website','slp-gravity-forms-locations-free') , '_' ),
										'slp-gravity-forms-locations-free'
									 ) ,
				'sl_hours'      => $this->slplus->WPML->get_text( 'label_hours' ,
										$this->slplus->settings->get_item( 'label_hours' , __('Hours','slp-gravity-forms-locations-free') , '_' ),
										'slp-gravity-forms-locations-free'
									) ,
				'sl_phone'      => $this->slplus->WPML->get_text( 'label_phone' ,
										$this->slplus->settings->get_item( 'label_phone' , __('Phone','slp-gravity-forms-locations-free') , '_' ),
										'slp-gravity-forms-locations-free'
									) ,
				'sl_fax'        => $this->slplus->WPML->get_text( 'label_fax' ,
										$this->slplus->settings->get_item( 'label_fax'  , __('Fax','slp-gravity-forms-locations-free')  , '_' ),
										'slp-gravity-forms-locations-free'
									)
				);
